...
//  SlideShowMagic
//
//  Created by Arda Ozupek on 19.04.2019.
//  Copyright © 2019 Arda Ozupek. All rights reserved.
//

#import "SSPicture.h"

@implementation SSPicture
...
- (void)processImage;
{
    [self processImageForTime:kCMTimeInvalid];
}

-(void)processImageForTime:(CMTime)time {
    [self processImageForTime:time withCompletionHandler:nil];
}

- (BOOL)processImageForTime:(CMTime)time withCompletionHandler:(void (^)(void))completion;
{
...
- (void)processImageUpToFilter:(GPUImageOutput<GPUImageInput> *)finalFilterInChain withCompletionHandler:(void (^)(UIImage *processedImage))block;
{
    ...
    [self processImageForTime:kCMTimeInvalid withCompletionHandler:^{
