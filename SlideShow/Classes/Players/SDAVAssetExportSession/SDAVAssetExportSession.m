...
@property (nonatomic, strong) void (^progressHandler)(CGFloat);
@end
...
- (void)exportAsynchronouslyWithCompletionHandler:(void (^)(void))handler progressHandler:(void (^)(CGFloat))progress
{
