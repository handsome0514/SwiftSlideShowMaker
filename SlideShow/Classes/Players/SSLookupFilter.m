...
#import "SSLookupFilter.h"

#if TARGET_IPHONE_SIMULATOR || TARGET_OS_IPHONE
NSString *const kSSLookupFilterFragmentShaderString = SHADER_STRING
(
...
@interface SSLookupFilter ()
{
    GLint intensityUniform;
}
@end

@implementation SSLookupFilter

#pragma mark - Life Cycle
-(id)init {
    self = [super initWithFragmentShaderFromString:kSSLookupFilterFragmentShaderString];
    if (self) {
