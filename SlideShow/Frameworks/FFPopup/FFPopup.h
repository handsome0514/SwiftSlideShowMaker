...
extern FFPopupLayout FFPopupLayoutMake(FFPopupHorizontalLayout horizontal, FFPopupVerticalLayout vertical, CGFloat offset) NS_SWIFT_NAME(FFPopupLayout(horizontal:vertical:));
...
/**
 If `YES`, the popup will show close button.
 
 @discussion The default value is `NO`.
 */
@property (nonatomic, assign) BOOL shouldShowClose;
